...
#ifndef LWIP_LOGI
#define LWIP_LOGI bk_printf
#endif // LWIP_LOGI

#ifndef LWIP_LOGE
#define LWIP_LOGE bk_printf
#endif // LWIP_LOGE

static uint32_t dns1;
...
static void wm_netif_status_static_callback(struct netif *n)
{
    if (n->flags & NETIF_FLAG_UP) {
        ...
        if (bk_feature_fast_dhcp_enable()) {
            ...
            os_memcpy((char *)&dns1, (char *)&fci.dns1, sizeof(fci.dns1));
        ...
        if(dhcp != NULL) {
            ...
            if (dhcp->state == DHCP_STATE_BOUND) {
                ...
                if (bk_feature_fast_dhcp_enable()) {
                    ...
                    dns1 = ip_addr_get_ip4_u32(dns_server);
                    struct wlan_fast_connect_info fci = {0};
                    wlan_read_fast_connect_info(&fci);
                    ...
                    os_memcpy((char *)&fci.dns1, (char *)&dns1, sizeof(dns1));
