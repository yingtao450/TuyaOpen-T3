...
#else
	return sys_ll_get_cpu2_int_0_31_status_value();
#endif
}
...
#else
	return sys_ll_get_cpu2_int_32_63_status_value();
#endif
}
...
#else
	reg = sys_ll_get_cpu2_int_32_63_status_value();
#endif
...
{
	//FIXME: the upper layer should refactory the implementation
