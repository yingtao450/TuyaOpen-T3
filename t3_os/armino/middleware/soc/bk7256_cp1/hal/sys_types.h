...
#define HOST_0_INTERRUPT_CTRL_BIT      (1 << SYS_CPU1_INT_0_31_EN_CPU1_HOST_0_IRQ_EN_POS)
#define HOST_0_SEC_INTERRUPT_CTRL_BIT  (1 << SYS_CPU1_INT_0_31_EN_CPU1_HOST_0_SEC_IRQ_EN_POS)
#define TIMER_INTERRUPT_CTRL_BIT       (1 << SYS_CPU1_INT_0_31_EN_CPU1_TIMER_INT_EN_POS)
#define UART0_INTERRUPT_CTRL_BIT       (1 << SYS_CPU1_INT_0_31_EN_CPU1_UART_INT_EN_POS)
#define PWM_INTERRUPT_CTRL_BIT         (1 << SYS_CPU1_INT_0_31_EN_CPU1_PWM_INT_EN_POS)
#define I2C_INTERRUPT_CTRL_BIT         (1 << SYS_CPU1_INT_0_31_EN_CPU1_I2C_INT_EN_POS)
#define SPI_INTERRUPT_CTRL_BIT         (1 << SYS_CPU1_INT_0_31_EN_CPU1_SPI_INT_EN_POS)
#define SADC_INTERRUPT_CTRL_BIT        (1 << SYS_CPU1_INT_0_31_EN_CPU1_SADC_INT_EN_POS)
#define IRDA_INTERRUPT_CTRL_BIT        (1 << SYS_CPU1_INT_0_31_EN_CPU1_IRDA_INT_EN_POS)
#define SDIO_INTERRUPT_CTRL_BIT        (1 << SYS_CPU1_INT_0_31_EN_CPU1_SDIO_INT_EN_POS)
#define GDMA_INTERRUPT_CTRL_BIT        (1 << SYS_CPU1_INT_0_31_EN_CPU1_GDMA_INT_EN_POS)
#define LA_INTERRUPT_CTRL_BIT          (1 << SYS_CPU1_INT_0_31_EN_CPU1_LA_INT_EN_POS)
#define TIMER1_INTERRUPT_CTRL_BIT      (1 << SYS_CPU1_INT_0_31_EN_CPU1_TIMER1_INT_EN_POS)
#define I2C1_INTERRUPT_CTRL_BIT        (1 << SYS_CPU1_INT_0_31_EN_CPU1_I2C1_INT_EN_POS)
#define UART1_INTERRUPT_CTRL_BIT       (1 << SYS_CPU1_INT_0_31_EN_CPU1_UART1_INT_EN_POS)
#define UART2_INTERRUPT_CTRL_BIT       (1 << SYS_CPU1_INT_0_31_EN_CPU1_UART2_INT_EN_POS)
#define SPI1_INTERRUPT_CTRL_BIT        (1 << SYS_CPU1_INT_0_31_EN_CPU1_SPI1_INT_EN_POS)
#define CAN_INTERRUPT_CTRL_BIT         (1 << SYS_CPU1_INT_0_31_EN_CPU1_CAN_INT_EN_POS)
#define USB_INTERRUPT_CTRL_BIT         (1 << SYS_CPU1_INT_0_31_EN_CPU1_USB_INT_EN_POS)
#define QSPI_INTERRUPT_CTRL_BIT        (1 << SYS_CPU1_INT_0_31_EN_CPU1_QSPI_INT_EN_POS)
#define FFT_INTERRUPT_CTRL_BIT         (1 << SYS_CPU1_INT_0_31_EN_CPU1_FFT_INT_EN_POS)
#define SBC_INTERRUPT_CTRL_BIT         (1 << SYS_CPU1_INT_0_31_EN_CPU1_SBC_INT_EN_POS)
#define AUD_INTERRUPT_CTRL_BIT         (1 << SYS_CPU1_INT_0_31_EN_CPU1_AUD_INT_EN_POS)
#define I2S_INTERRUPT_CTRL_BIT         (1 << SYS_CPU1_INT_0_31_EN_CPU1_I2S_INT_EN_POS)
#define JPEGENC_INTERRUPT_CTRL_BIT     (1 << SYS_CPU1_INT_0_31_EN_CPU1_JPEGENC_INT_EN_POS)
#define JPEGDEC_INTERRUPT_CTRL_BIT     (1 << SYS_CPU1_INT_0_31_EN_CPU1_JPEGDEC_INT_EN_POS)
#define LCD_INTERRUPT_CTRL_BIT         (1 << SYS_CPU1_INT_0_31_EN_CPU1_LCD_INT_EN_POS)
#define DMA2D_INTERRUPT_CTRL_BIT       (1 << SYS_CPU0_INT_0_31_EN_CPU0_DMA2D_INT_EN_POS)
#define WIFI_MODEM_EN                  (1 << SYS_CPU1_INT_0_31_EN_CPU1_WIFI_INT_PHY_MPB_EN_POS)
#define WIFI_MODEM_RC_EN               (1 << SYS_CPU1_INT_0_31_EN_CPU1_WIFI_INT_PHY_RIU_EN_POS)
#define WIFI_MAC_TX_RX_TIMER_INT_BIT   (1 << SYS_CPU1_INT_0_31_EN_CPU1_WIFI_MAC_INT_TX_RX_TIMER_EN_POS)

//int_32_63_en
#define WIFI_MAC_TX_RX_MISC_INT_BIT    (1 << SYS_CPU1_INT_32_63_EN_CPU1_WIFI_MAC_INT_TX_RX_MISC_EN_POS)
#define WIFI_MAC_RX_TRIGGER_INT_BIT    (1 << SYS_CPU1_INT_32_63_EN_CPU1_WIFI_MAC_INT_RX_TRIGGER_EN_POS)
#define WIFI_MAC_TX_TRIGGER_INT_BIT    (1 << SYS_CPU1_INT_32_63_EN_CPU1_WIFI_MAC_INT_TX_TRIGGER_EN_POS)
#define WIFI_MAC_PORT_TRIGGER_INT_BIT  (1 << SYS_CPU1_INT_32_63_EN_CPU1_WIFI_MAC_INT_PROT_TRIGGER_EN_POS)
#define WIFI_MAC_GEN_INT_BIT           (1 << SYS_CPU1_INT_32_63_EN_CPU1_WIFI_MAC_INT_GEN_EN_POS)
#define WIFI_HSU_INTERRUPT_CTRL_BIT    (1 << SYS_CPU1_INT_32_63_EN_CPU1_WIFI_HSU_IRQ_EN_POS)
#define WIFI_MAC_WAKEUP_INT_BIT        (1 << SYS_CPU1_INT_32_63_EN_CPU1_WIFI_INT_MAC_WAKEUP_EN_POS)
#define DM_INTERRUPT_CTRL_BIT          (1 << SYS_CPU1_INT_32_63_EN_CPU1_DM_IRQ_EN_POS)
#define BLE_INTERRUPT_CTRL_BIT         (1 << SYS_CPU1_INT_32_63_EN_CPU1_BLE_IRQ_EN_POS)
#define BT_INTERRUPT_CTRL_BIT          (1 << SYS_CPU1_INT_32_63_EN_CPU1_BT_IRQ_EN_POS)
#define PWM1_INTERRUPT_CTRL_BIT        (1 << SYS_CPU1_INT_32_63_EN_CPU1_PWM1_INT_EN_POS)
#define MBOX0_INTERRUPT_CTRL_BIT       (1 << SYS_CPU1_INT_32_63_EN_CPU1_MBOX0_INT_EN_POS)
#define MBOX1_INTERRUPT_CTRL_BIT       (1 << SYS_CPU1_INT_32_63_EN_CPU1_MBOX1_INT_EN_POS)
#define BMC64_INTERRUPT_CTRL_BIT       (1 << SYS_CPU1_INT_32_63_EN_CPU1_BMC64_INT_EN_POS)
#define TOUCHED_INTERRUPT_CTRL_BIT     (1 << SYS_CPU1_INT_32_63_EN_CPU1_TOUCHED_INT_EN_POS)
#define USBPLUG_INTERRUPT_CTRL_BIT     (1 << SYS_CPU1_INT_32_63_EN_CPU1_USBPLUG_INT_EN_POS)
...
typedef enum
{
	...
	WAKEUP_SOURCE_INT_WIFI   = 2,// it is the same as SYSTEM_WAKE in the project
	WAKEUP_SOURCE_INT_BT     = 2,// it is the same as SYSTEM_WAKE in the project
	WAKEUP_SOURCE_INT_NONE   = 5,
}wakeup_source_t;
