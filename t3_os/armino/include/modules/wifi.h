...
/**
 * @brief regist bcn miss callback.
 *
 * @param bcnmiss_cb the callback function, this function should return bool value indicating whether disconnected from router or not.
 *
 * @return
 * 	-BK_OK: on success
 * 	-others:real error, used for future.
