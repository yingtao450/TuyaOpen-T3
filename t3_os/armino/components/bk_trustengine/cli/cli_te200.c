...
extern int te200_main( int argc, char *argv[] );
...
static void cli_te200_selftest(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
	int ret = 0;
	TE200_SET_CPU_FREQ_TO_160M();
	ret = te200_main(argc, argv);
...
static const struct cli_command s_te200_commands[] = {
	...
	{"te200_selftest", "te200_selftest", cli_te200_selftest},
};
