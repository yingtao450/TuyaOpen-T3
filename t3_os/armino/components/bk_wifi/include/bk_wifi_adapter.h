...
/////////////////////////
	...
	int (*_pbkdf2_sha1)(const char *passphrase, const u8 *ssid, size_t ssid_len,
		int iterations, u8 *buf, size_t buflen);
	int (*_sha1_prf)(const u8 *key, size_t key_len, const char *label,
	     const u8 *data, size_t data_len, u8 *buf, size_t buf_len);
	int (*_omac1_aes_128_vector)(const u8 *key, size_t num_elem,
			const u8 *addr[], const size_t *len, u8 *mac);
	int (*_aes_wrap)(const u8 *kek, size_t kek_len, int n, const u8 *plain,
			  u8 *cipher);
	int (*_rc4_skip)(const u8 *key, size_t keylen, size_t skip,
	     u8 *data, size_t data_len);
	int (*_hmac_md5)(const u8 *key, size_t key_len, const u8 *data, size_t data_len,
	     u8 *mac);
	int (*_hmac_sha1)(const u8 *key, size_t key_len, const u8 *data, size_t data_len,
	       u8 *mac);
	int (*_aes_unwrap)(const u8 *kek, size_t kek_len, int n,
			    const u8 *cipher, u8 *plain);
	void (*__crypto_ecdh_deinit)(void *ecdh);
	void * (*__crypto_ecdh_init)(int group);
	struct wpabuf * (*__crypto_ecdh_set_peerkey)(void *ecdh, int inc_y, const u8 *key, size_t len);
	struct wpabuf * (*__crypto_ecdh_get_pubkey)(void *ecdh, int inc_y);
	int (*_sha256_vector)(size_t num_elem, const u8 *addr[], const size_t *len,
			  u8 *mac);
	int (*_sha384_vector)(size_t num_elem, const u8 *addr[], const size_t *len,
			  u8 *mac);
	int (*_sha512_vector)(size_t num_elem, const u8 *addr[], const size_t *len,
			  u8 *mac);
	int (*_hmac_sha256)(const u8 *key, size_t key_len, const u8 *data,
			size_t data_len, u8 *mac);
	int (*_hmac_sha384)(const u8 *key, size_t key_len, const u8 *data,
			size_t data_len, u8 *mac);
	int (*_hmac_sha512)(const u8 *key, size_t key_len, const u8 *data,
			size_t data_len, u8 *mac);
	int (*_hmac_sha256_kdf)(const u8 *secret, size_t secret_len,
				const char *label, const u8 *seed, size_t seed_len,
				u8 *out, size_t outlen);
	int (*_hmac_sha384_kdf)(const u8 *secret, size_t secret_len,
				const char *label, const u8 *seed, size_t seed_len,
				u8 *out, size_t outlen);
	int (*_hmac_sha512_kdf)(const u8 *secret, size_t secret_len,
				const char *label, const u8 *seed, size_t seed_len,
				u8 *out, size_t outlen);
	void * (*__crypto_bignum_init)(void);
	int (*_omac1_aes_128)(const u8 *key, const u8 *data, size_t data_len, u8 *mac);
	int (*_sha256_prf)(const u8 *key, size_t key_len, const char *label,
			   const u8 *data, size_t data_len, u8 *buf, size_t buf_len);
	int (*_sha384_prf)(const u8 *key, size_t key_len, const char *label,
			   const u8 *data, size_t data_len, u8 *buf, size_t buf_len);
	int (*_sha512_prf)(const u8 *key, size_t key_len, const char *label,
			   const u8 *data, size_t data_len, u8 *buf, size_t buf_len);
	int (*_hmac_sha384_vector)(const u8 *key, size_t key_len, size_t num_elem,
		const u8 *addr[], const size_t *len, u8 *mac);
	int (*_hmac_sha256_vector)(const u8 *key, size_t key_len, size_t num_elem,
				   const u8 *addr[], const size_t *len, u8 *mac);
	int (*_hmac_sha1_vector)(const u8 *key, size_t key_len, size_t num_elem,
		     const u8 *addr[], const size_t *len, u8 *mac);
	int (*_hmac_sha512_vector)(const u8 *key, size_t key_len, size_t num_elem,
			const u8 *addr[], const size_t *len, u8 *mac);
	int (*__crypto_bignum_rand)(void *r, const void *m);
	void (*__crypto_bignum_deinit)(void *n, int clear);
	void * (*__crypto_bignum_init_set)(const u8 *buf, size_t len);
	void * (*__crypto_bignum_init_uint)(unsigned int val);
	int (*__crypto_bignum_to_bin)(const void *a,
							 u8 *buf, size_t buflen, size_t padlen);
	int (*__crypto_bignum_add)(const void *a, const void *b, void *c);
	int (*__crypto_bignum_sub)(const void *a, const void *b, void *c);
	int (*__crypto_bignum_mod)(const void *a, const void *b, void *c);
	int (*__crypto_bignum_cmp)(const void *a, const void *b);
	int (*__crypto_bignum_mulmod)(const void *a, const void *b, const void *c, void *d);
	int (*__crypto_bignum_inverse)(const void *a, const void *b, void *c);
	int (*__crypto_bignum_addmod)(const void *a, const void *b, const void *c, void *d);
	int (*__crypto_bignum_sqrmod)(const void *a, const void *b, void *c);
	int (*__crypto_bignum_exptmod)(const void *a, const void *b, const void *c, void *d);
	int (*__crypto_bignum_is_zero)(const void *a);
	int (*__crypto_bignum_is_one)(const void *a);
	int (*__crypto_bignum_is_odd)(const void *a);
	int (*__crypto_bignum_rshift)(const void *a, int n, void *r);
	int (*__crypto_bignum_legendre)(const void *a, const void *p);
	void *(*__crypto_ec_init)(int group);
	void (*__crypto_ec_deinit)(void *e);
	int (*_sha256_prf_bits)(const u8 *key, size_t key_len, const char *label,
		    const u8 *data, size_t data_len, u8 *buf,
		    size_t buf_len_bits);
	void *(*__crypto_ec_point_init)(void *e);
	void (*__crypto_ec_point_deinit)(void *p, int clear);
	size_t (*__crypto_ec_prime_len)(void *e);
	const void *(*__crypto_ec_get_prime)(void *e);
	const void *(*__crypto_ec_get_order)(void *e);
	size_t (*__crypto_ec_order_len)(void *e);
	int (*__crypto_ec_point_mul)(void *e, const void *p, const void *b, void *res);
	int (*__crypto_ec_point_to_bin)(void *e, const void *point, u8 *x, u8 *y);
	void *(*__crypto_ec_point_from_bin)(void *e, const u8 *val);
	int (*__crypto_ec_point_add)(void *e, const void *a, const void *b, void *c);
	int (*__crypto_ec_point_invert)(void *e, void *p);
	int (*__crypto_ec_point_cmp)(const void *e, const void *a, const void *b);
	const void *(*__crypto_ec_get_a)(void *e);
	const void *(*__crypto_ec_get_b)(void *e);
	void *(*__crypto_ec_point_compute_y_sqr)(void *e, const void *x);
	int (*__crypto_ec_point_is_at_infinity)(void *e, void *p);
	int (*__crypto_ec_point_is_on_curve)(void *e, void *p);
	size_t (*__crypto_ec_prime_len_bits)(void *e);
