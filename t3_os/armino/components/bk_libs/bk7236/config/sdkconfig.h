...
#define CONFIG_LOWER_TX_RATE_FOR_PS 1
#define CONFIG_SPECIAL_FRAME_SHORT_RETRY_LIMIT_WHEN_BEACON_LOSS 1
#define CONFIG_SPECIAL_FRAME_SHORT_RETRY_LIMIT 3
#define CONFIG_SPECIAL_FRAME_LONG_RETRY_LIMIT 1
...
#define CONFIG_TASK_WPAS_PRIO 3
