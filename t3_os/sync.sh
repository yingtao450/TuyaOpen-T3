...
file_list=($(find . \( -path ./docs -o -path ./bk_idk/aboot-main -o -path ./bk_idk/tools/env_tools/beken_utils/scripts -o -path ./bk_idk/tools/build_tools/kconfig_new -o -path ./bk_idk/tools/build_tools/part_table_tools/otherScript \) -prune , -type f))
